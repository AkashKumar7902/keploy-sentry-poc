...
- [`sentry-integration-plan.md`](sentry-integration-plan.md) — the full brainstorm: pitch, architecture, user flows, what-to-build, phasing, open questions, risks.
...
Brainstorm + validation only. No production code changes yet.
